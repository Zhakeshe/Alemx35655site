...
const T = {
  ...
  ru: {
    ...
    "search.back": "Назад", "search.empty": "Команда не найдена.", "search.hint": "Доступно 14 000+ команд из базы FTC Scout", "tc.tab.teams": "Команды", "tc.tab.judging": "Судейство", "tc.tab.schedule": "Расписание", "tc.tab.search": "Поиск", "tc.tab.live": "Live FTC", "tc.tab.fll": "FLL", "tc.tab.rules": "Правила", "tc.tab.myteam": "⭐ Моя команда", "tc.soon": "Скоро", "tc.soon.desc": "Информация будет опубликована перед соревнованием", "tc.search.placeholder": "Поиск команды или участника...", "tc.stream.soon": "Ссылка на стрим появится скоро",
