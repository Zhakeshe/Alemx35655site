...
const T = {
  kz: {
    ...
    "nav.ranking": "Рейтинг", "nav.rivals": "Командалар",
    ...
    "sec.rivals.eye": "Команды", "sec.rivals.title": "Командалар",
    "sec.rivals.desc": "Маусым бойынша альянс серіктестері мен қарсыластар.",
    "rank.allies": "Альянс серіктестері", "rank.rivals": "Қарсыластар",
  ...
  ru: {
    ...
    "nav.ranking": "Рейтинг", "nav.rivals": "Команды",
    ...
    "sec.rivals.eye": "Команды", "sec.rivals.title": "Команды",
    "sec.rivals.desc": "Союзники и соперники на протяжении сезона.",
    "rank.allies": "Союзники по альянсу", "rank.rivals": "Соперники",
  ...
  en: {
    ...
    "nav.ranking": "Rankings", "nav.rivals": "Teams",
    ...
    "sec.rivals.eye": "Teams", "sec.rivals.title": "Teams",
    "sec.rivals.desc": "Alliance partners and rivals throughout the season.",
    "rank.allies": "Alliance Partners", "rank.rivals": "Rivals",
