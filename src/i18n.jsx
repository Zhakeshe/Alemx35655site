...
const T = {
  kz: {
    ...
    "search.back": "Артқа", "search.empty": "Команда табылмады.", "search.hint": "FTC Scout дерекқорынан 14 000+ команда ақпараты қолжетімді", "tc.tab.teams": "Командалар", "tc.tab.judging": "Бағалау", "tc.tab.schedule": "Кесте", "tc.soon": "Жақын арада", "tc.soon.desc": "Ақпарат жарыс алдында жарияланады",
  ...
  ru: {
    ...
    "search.back": "Назад", "search.empty": "Команда не найдена.", "search.hint": "Доступно 14 000+ команд из базы FTC Scout", "tc.tab.teams": "Команды", "tc.tab.judging": "Судейство", "tc.tab.schedule": "Расписание", "tc.soon": "Скоро", "tc.soon.desc": "Информация будет опубликована перед соревнованием",
